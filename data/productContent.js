export const moneyFeatures = [
  ...
  },
  {
    ...
    title: "Spending Disbursement Alerts",
    text: "Get automatic notifications when your money is disbursed for spending."
  },
  {
    icon: "receipt_long",
    title: "Bill and Airtime Flows",
    text: "Plan recurring expenses like bills, airtime, and data from the right money envelope."
  },
  {
    icon: "query_stats",
    title: "Real-Time Position",
    text: "See how much is left in each envelope before you spend."
  },
  {
    icon: "history",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes. Some envelopes can be adjusted when your needs change. Strict locks or SafeLock features may have separate rules that are shown before activation."
  },
  {
